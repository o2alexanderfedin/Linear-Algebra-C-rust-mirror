...
extern "C" {
    ...
    fn is_matrix_orthogonal(m1: *mut Matrix, m2: *mut Matrix) -> bool;
    fn rotate2_d(m: *mut Matrix, theta: f64) -> *mut Matrix;
    fn cos(_: f64) -> f64;
    fn sin(_: f64) -> f64;
    fn backtrace(_: *mut *mut (), __size: i32) -> i32;
    fn backtrace_symbols(_: *const *mut (), __size: i32) -> *mut *mut i8;
    fn exit(_: i32) -> ();
    fn round(_: f64) -> f64;
    fn sqrt(_: f64) -> f64;
}
